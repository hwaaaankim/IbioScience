...
public class AdminClientController {
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).MEM_CLIENT_SEARCH)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).MEM_CLIENT_APPLY_MANAGER)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).MEM_CLIENT_WITHDRAW_MANAGER)")
    ...
    public String clientWithDrawManager(
        ...
        String qsBase = buildQueryStringBase(cond);
    ...
    @PreAuthorize("@adminMenuFacade.canUpdateByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).MEM_CLIENT_WITHDRAW_MANAGER)")
    @ResponseBody
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).CRM_INFORMATION)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).CRM_ORDER_LIST)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).CRM_ESTIMATE_LIST)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).CRM_REVIEW_LIST)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).CRM_BENEFIT)")
    ...
    @PreAuthorize("@adminMenuFacade.canViewByPageCode(T(com.dev.IbioScience.enums.auth.role.AdminPageCodes).CRM_WISH_LIST)")
