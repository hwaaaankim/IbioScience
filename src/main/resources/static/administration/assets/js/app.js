    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/us.svg")
        : "sp" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/spain.svg")
        : "gr" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/germany.svg")
        : "it" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/italy.svg")
        : "ru" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/russia.svg")
        : "ch" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/china.svg")
        : "fr" == e
        ? (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/french.svg")
        : "ar" == e &&
          (document.getElementById("header-lang-img").src =
            "/administration/assets/images/flags/ae.svg"),
      localStorage.setItem("language", e),
      null == (a = localStorage.getItem("language")) && n(t),
      (e = new XMLHttpRequest()).open("GET", "/administration/assets/lang/" + a + ".json"),
  ...
  function i() {
    ...
    !t ||
      ...
      ((n = document.createElement("ul")).innerHTML =
        '<a href="#" class="logo"><img src="/administration/assets/images/logo-sm.png" alt="" height="22"></a>'),
      Array.from(
