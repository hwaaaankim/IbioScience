(function() {
	...
	function renderAttachmentPreview() {
		...
		el.mailAttachmentPreview.innerHTML = files.map(function(file) {
	...
	function updateSendButtonState() {
		...
		const bodyText = (state.quill.getText() || '').trim();

		el.sendBtn.disabled = !(subject && bodyText);
	}
	...
	async function sendEstimateMail() {
		...
		Array.from(el.mailAttachments.files || []).forEach(function(file) {
